...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "scsbhipster@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "scsbhipster API";

        private String description = "scsbhipster API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "scsbhipster";
